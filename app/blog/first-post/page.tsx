    ...
    <main className="prose min-h-screen max-w-5xl bg-primary m-auto text-four mx-auto py-2">
                ...
                {Array.isArray(post.content) &&
                  post.content.map(contentItem => (
                    <div key={contentItem.id}>
                      ...
                      {contentItem.paraChildPara && <p className="pb-4">{contentItem.paraChildPara}</p>}
                    </div>
                  ))}
              </div>
            </div>
      ...
      <section className="min-h-screen border-third uppercase tracking-wide text-four">
        ...
        <div className="flex gap-4 text-sm py-2 items-center font-semibold justify-center">
          <span className="font-bold">Himanshu</span>
        ...
        <div className="">
          <div className="relative">
            <div className="absolute h-44 w-full flex justify-center items-center">
              <div className="h-[1px] bg-custom-radial-lg w-full"></div>
            </div>
            <div className="absolute h-20 w-full flex flex-col justify-center items-center">
              <Image className="rounded-full" src="/me.webp" width={40} height={40} alt="neel" />
              <div className="absolute bottom-0 text-center">
                ...
                <div className="absolute w-full text-center -bottom-24">
                  <a
                    href="/"
                    target="_blank"
                    className="flex justify-center items-center bg-secondary rounded-full gap-2 text-primary p-2 px-3"
                  >
                    suggest an idea
                  </a>
                </div>
