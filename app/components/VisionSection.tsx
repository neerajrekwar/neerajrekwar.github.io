          ...
          <div className=" p-2 border-four  md:flex flex-col justify-between">
            ...
            <div className=" md:flex gap-4 border-five">
              <div className="flex md:flex-col gap-2 my-10 flex-row-reverse">
                <h3 className="md:text-base text-five font-semibold">Ours technology to use improving web appearance.</h3>
                <div className="flex ">
              ...
              <div className="border-four flex md:flex-col gap-2 my-10 justify-between flex-row">
                <h5 className="text-4xl md:text-base text-five font-semibold">use library</h5>
                <div>
                  <p className="bg-seven p-3 rounded-2xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus corporis tempora commodi minima blanditiis ipsum esse ab nobis repellat repudiandae.</p>
              ...
              <div className=" md:flex md:flex-col gap-2 my-10 justify-between">
                <h5 className="text-4xl md:text-base text-five font-semibold">Framework </h5>
                <div>
                  <p className="bg-seven p-3 rounded-2xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ex qui quisquam velit?</p>
                  <div className="flex  justify-start">
                    <span className="p-1 m-2 bg-seven rounded-lg fill-five">
                      <svg xmlns="http://www.w3.org/2000/svg" width={44} height={44} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-brand-react">
              ...
              <ul className="flex flex-wrap md:grid md:grid-flow-row-dense md:grid-cols-3 md:grid-rows-3  text-five  h-auto">
                ...
                <li className="col-span-2 flex items-center justify-center h-28 md:h-auto w-full md:w-auto p-1 m-2 rounded-2xl hover:scale-95 duration-500 transition-all bg-secondary text-[#E5D352]">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    width={64} height={64} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="basis-1/2  icon icon-tabler icons-tabler-outline icon-tabler-devices">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
