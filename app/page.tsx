  ...
  return (
    <main className="flex flex-col items-center justify-between p-24">
      <section className=" md:flex border-2 border-lime-500 justify-end place-items-start h-screen w-full text-sm antialiased ">
        ...
        <div className="border-2 left-0 flex h-48  items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:size-auto lg:bg-none">
          <ul>
            <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos impedit quisquam laborum, ea, eaque nobis velit autem qui quibusdam itaque cupiditate a voluptatem voluptatibus, quia esse possimus facere accusamus adipisci.</li>
          </ul>
        </div>
      </section>
