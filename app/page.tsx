        ...
        <div className="m-2 p-1 border-2 border-gray-400 ">
          <figure className="flex-1 sm:flex border-2">
            <div className="m-2 lg:w-[50vw] md:w-[20vw]">
              <Image src="https://neerajrekwar.github.io/me.jpg" width="{350}" height="{320}" alt="Picture of the author" className="rounded shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)]" />
            </div>
