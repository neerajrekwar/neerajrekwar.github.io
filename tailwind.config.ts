  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'custom-radial-md': 'radial-gradient(71% 109% at -14% 0%, var(--four) 0%, hsla(0, 0%, 100%, .1) 100%), radial-gradient(59% 138% at 120% -66%, var(--four) 0%, hsla(0, 0%, 100%, .1) 100%)',
        'custom-radial-lg': 'radial-gradient(38% 107% at 27% -33%, var(--four) 0%, hsla(0, 0%, 100%, .1) 100%), radial-gradient(32% 104% at 112% 0%, var(--four) 0%, hsla(0, 0%, 100%, .1) 100%)',
